...
const BookingPopup = ({ selectedSlots, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      ...
      <div className="relative bg-white p-6 rounded-lg shadow-xl w-full max-w-sm border border-gray-300">
        ...
        <form className="space-y-4">
          ...
          <div className="flex flex-col">
            ...
            <textarea
              ...
              onChange={handleChange}
              className="w-full border border-gray-300 rounded-md p-2 h-20 focus:outline-none focus:ring-1 focus:ring-blue-500"
